          ...
          >
            ...
            <button
              onClick={() => {
                ...
                pushToast(
                  selected
                    ? `${plan.name} is already your active plan. : `{plan.name} plan selected. Payment checkout will be connected during deployment.`,
            ...
            >
              {selected ? (<ShieldCheck size={16} /> Current plan : 'Select ' + plan.name}
            </button>
          </div>
        );
      })}
